...
// _has_ that language, otherwise shit might happen ;-)
HTMLArea.loadPlugin = function(pluginName) {
    alert('loadPlugin does not work across browsers. You should directly embed <script> tags in your page instead of calling HTMLArea.loadPlugin');
    var dir = _editor_url + "plugins/" + pluginName;
    var plugin = pluginName.replace(/([a-z])([A-Z])([a-z])/g,
                    function (str, l1, l2, l3) {
                        return l1 + "-" + l2.toLowerCase() + l3;
...
/**
 * Variant of HTMLArea.loadPlugin which takes an optional second argument 'baseURL'.
 * This allows users to add their own plugins in the wikidata directory   
 */
HTMLArea.loadCustomPlugin = function(pluginName, baseURL) {
    alert('loadCustomPlugin does not work across browsers. You should directly embed <script> tags in your page instead of calling HTMLArea.loadPlugin');
    var dir = (baseURL || _editor_url + "plugins/" + pluginName);
    var plugin = pluginName.replace(/([a-z])([A-Z])([a-z])/g,
                    function (str, l1, l2, l3) {
                        return l1 + "-" + l2.toLowerCase() + l3;
                    }).toLowerCase() + ".js";
...
HTMLArea.is_webkit = /applewebkit/.test(navigator.appVersion.toLowerCase());
HTMLArea.is_gecko  = (navigator.product == "Gecko") && !HTMLArea.is_webkit;
...
HTMLArea.checkSupportedBrowser = function() {
	...
	return HTMLArea.is_gecko || HTMLArea.is_webkit || HTMLArea.is_ie;
};
...
HTMLArea.prototype._getSelection = function() {
	if (HTMLArea.is_ie) {
	    this._doc.parentWindow.focus(); // Needed for IE8 (and doesn't harm in other versions)
