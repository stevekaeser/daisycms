...
config. BalloonImgPath = daisy.mountPoint + '/resources/js/tooltip/tip_balloon/'; // Path to images (border, corners, stem), in quotes. Path must be relative to your HTML file.
