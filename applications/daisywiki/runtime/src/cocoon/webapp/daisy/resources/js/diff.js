...
var res = dojo.i18n.getLocalization("daisy.widget", "messages");
...
function constructToolTipC(elem){
   ...
   return changes_html+
          ...
          "      <a href=#"+previous_id+" onClick='scrollToEvent(event)'><img class='diff-icon' src='"+imagePath+"diff-previous.gif' title='"+res["diff.go-to-previous"]+"'/></a>"+
          "    </td>"+
          "    <td>"+
          "      &#160;<a href='#"+change_id+"'>#"+change_id+"</a>&#160;"+
          "    </td>"+
          "    <td class='diff-tooltip-next'>"+
          "      <a href='#"+next_id+"' onClick='scrollToEvent(event)'><img class='diff-icon' src='"+imagePath+"diff-next.gif' title='"+res["diff.go-to-next"]+"'/></a>"+
          "    </td>"+
          "  </tr>"+
          "</table>";
}
...
function getDiff() {
    var doc1 = daisy.util.parseDaisyLink(dojo.widget.byId("document1").getValue());
    var doc2 = daisy.util.parseDaisyLink(dojo.widget.byId("document2").getValue());
    var diffType = dojo.byId("diffType").options[dojo.byId("diffType").selectedIndex].value;

    if (doc1 == null || doc2 == null || doc1.version == null || doc2.version == null) {
    ...
    if (doc1.branch != null) params.branch = doc1.branch;
    if (doc1.language != null) params.language = doc1.language;
    params.otherDocumentId = doc2.documentId;
    if (doc2.branch != null) params.otherBranch = doc2.branch;
    if (doc2.language != null) params.otherLanguage = doc2.language;
    params.otherVersion = doc2.version;
    params.contentDiffType = diffType;

    var url = daisy.mountPoint + "/" + daisy.site.name + "/" + doc1.documentId + "/version/" + doc1.version + "/diff";
