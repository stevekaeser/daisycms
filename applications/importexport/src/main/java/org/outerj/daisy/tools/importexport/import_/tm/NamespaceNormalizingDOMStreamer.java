// Don't add a Daisy license header here
// Note: this file is based on code from Apache Cocoon
/*
...
public class NamespaceNormalizingDOMStreamer {
    ...
    public static void stream(Node node, ContentHandler contentHandler, LexicalHandler lexicalHandler) throws SAXException {
        new NamespaceNormalizingDOMStreamer(contentHandler, lexicalHandler).stream(node);
    }

    private NamespaceNormalizingDOMStreamer(ContentHandler contentHandler, LexicalHandler lexicalHandler) {
     ...
     */
    private void stream(Node pos) throws SAXException {
     ...
     */
    private void endNode(Node node) throws org.xml.sax.SAXException {
