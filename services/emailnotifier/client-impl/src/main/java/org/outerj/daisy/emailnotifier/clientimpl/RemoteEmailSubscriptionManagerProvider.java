...
public class RemoteEmailSubscriptionManagerProvider implements ExtensionProvider {
    public Object createExtension(Repository repository) {
        return new RemoteEmailSubscriptionManager((RemoteRepositoryImpl)repository);
    }
}
