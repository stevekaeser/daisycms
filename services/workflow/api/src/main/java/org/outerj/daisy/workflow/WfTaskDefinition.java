...
public interface WfTaskDefinition {
    String getName();
    ...
    WfVariableDefinition getVariable(String name, VariableScope scope);

    List<WfVariableDefinition> getVariables();

    WfNodeDefinition getNode();

    TaskDefinitionDocument getXml();
}
