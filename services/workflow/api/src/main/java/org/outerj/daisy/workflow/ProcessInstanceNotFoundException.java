...
public class ProcessInstanceNotFoundException extends WorkflowException {
    private String id;
    ...
    public ProcessInstanceNotFoundException(Map state) {
    ...
    public String getMessage() {
        return "There is no workflow process instance with ID " + id;
    }
