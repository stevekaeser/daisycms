...
class ProcessVariableGetter extends AbstractVariableGetter {
    private final String varName;

    public ProcessVariableGetter(String varName) {
    ...
    protected Object retrieveValue(Provider provider) throws WorkflowException {
        ...
        return contextInstance.getLocalVariable(varName, processInstance.getRootToken());
    }

    protected WfVariableDefinition getVariableDefinition(Provider provider) throws WorkflowException {
        return provider.getProcessDefinition().getGlobalVariable(varName);
    }
}
