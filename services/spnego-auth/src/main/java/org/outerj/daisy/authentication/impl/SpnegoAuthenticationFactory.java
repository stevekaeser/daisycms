...
/**
 * Constructs and registers SpnegoAuthenticationSchemes with the UserAuthenticator.
 *
 */
public class SpnegoAuthenticationFactory {
    private PluginRegistry pluginRegistry;
    private Map<String, AuthenticationScheme> schemes = new HashMap<String, AuthenticationScheme>();

    public SpnegoAuthenticationFactory(Configuration configuration, PluginRegistry pluginRegistry) throws Exception {
    ...
    private void configure(Configuration configuration) throws ConfigurationException {
        ...
        for (Configuration schemeConf : schemeConfs) {
            ...
            AuthenticationScheme scheme = new SpnegoAuthenticationScheme(name, description, userCreator);
