 ...
 */
public class OpenOfficeTextExtractor extends AbstractTextExtractor implements TextExtractor {
    ...
    public OpenOfficeTextExtractor(List<String> mimeTypes, PluginRegistry pluginRegistry) {
    ...
    public String getText(InputStream is) throws Exception {
        ...
        if (zipEntryName != null && zipEntryName.equals("content.xml")) {
            ...
            parser.setInput(new XmlReader(zis));
