...
public interface TaskAction {
    ...
    public void setup(DocumentSelection documentSelection, TaskSpecification taskSpecification, Repository repository);
    
    public void execute(VariantKey variantKey);
