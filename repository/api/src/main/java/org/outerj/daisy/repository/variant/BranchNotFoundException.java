...
public class BranchNotFoundException extends RepositoryException {
    private String name;
    private long id;
    ...
    public BranchNotFoundException(Map params) {
    ...
    public String getMessage() {
        if (name == null)
            return "A branch with ID " + id + " does not exist.";
        else
            return "A branch named \"" + name + "\" does not exist.";
    }
}
