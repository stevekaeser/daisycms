 ...
 */
public class CollectionNotFoundException extends RepositoryException {
    private long id;
    private String name;
    ...
    public String getMessage() {
        if (name == null)
            return "The collection with ID " + id + " does not exist.";
        else
            return "The collection named \"" + name + "\" does not exist.";
    }
}
