...
public class DayOfYearFunction extends DateComponentFunction {
    ...
    protected String[] getSqlFunction(SqlGenerationContext context) {
        return context.getJdbcHelper().getDayOfYearFunction();
    }

    public ValueExpr clone() {
        DayOfYearFunction clone = new DayOfYearFunction();
