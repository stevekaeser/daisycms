...
public class DayOfWeekFunction extends DateComponentFunction {
    ...
    protected String[] getSqlFunction(SqlGenerationContext context) {
        return context.getJdbcHelper().getDayOfWeekFunction();
    }

    public ValueExpr clone() {
        DayOfWeekFunction clone = new DayOfWeekFunction();
