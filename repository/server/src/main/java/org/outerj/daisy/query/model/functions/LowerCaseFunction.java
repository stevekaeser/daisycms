...
public class LowerCaseFunction extends AbstractCaseFunction {
    ...
    protected String getSqlFunctionName(SqlGenerationContext context) {
        return context.getJdbcHelper().getLowerCaseFunction();
    }
    ...
    public ValueExpr clone() {
        LowerCaseFunction clone = new LowerCaseFunction();
